		...
		<div class="container">
			...
			<div id="signup" class="hero-unit">  
				...
				<div class="row">
					<div class="span9">
						<p class="lead">
						Your team, your idea, your most productive 48 hours. Free pizzas, Redbull and Facebook engineers to support you throughout the weekend. Build something cool with Facebook and Google APIs to win cash prizes, gadgets and fast-track admission to Startup+ Accelerator. Senior recruiters from Facebook and Microsoft will be present, looking to scout talent. So sign up either on your own or with a team and start hacking!
						</p>
					...
					<div class="span5">
						<div class="sponsor_panel title_sponsors">
							<h4>Our Friends:</h4>
							<img src="images/microsoft.jpg"/><img src="images/facebook.jpg"/><img src="images/oxford.jpg"/>
						</div>
					</div>
				</div>
				<div class="row">
